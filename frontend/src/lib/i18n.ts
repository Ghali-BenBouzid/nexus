...
const en = {
  ...
  hiw: {
    ...
    parts: {
      supervisor: "The agent you actually talk to. It reads your message in the context of the conversation and decides: answer straight from the reports already gathered, or start a fresh research run. A follow-up the existing sources already cover never pays for a new run.",
    ...
    stack: [
      { lead: "Supervisor", rest: " reads your message and either answers from the existing reports or starts a research run." },
    ...
    aria: "A supervisor reads each message and either answers directly or starts a research run: an orchestrator plans the question, you confirm the plan, a fan-out of researcher agents gathers sources, then a consolidation step and a writer turn it into a cited report.",
  },
  eng: {
...
const fr: Dict = {
  ...
  hiw: {
    ...
    parts: {
      supervisor: "L'agent à qui vous parlez vraiment. Il lit votre message dans le contexte de la conversation et décide : répondre directement à partir des rapports déjà rassemblés, ou lancer une nouvelle recherche. Une question de suivi déjà couverte par les sources existantes ne paie jamais une nouvelle recherche.",
    ...
    stack: [
      { lead: "Superviseur", rest: " lit votre message et répond à partir des rapports existants ou lance une recherche." },
    ...
    aria: "Un superviseur lit chaque message et répond directement ou lance une recherche : un orchestrateur planifie la question, vous confirmez le plan, un fan-out d'agents chercheurs rassemble les sources, puis une étape de consolidation et un rédacteur en font un rapport sourcé.",
  },
  eng: {
