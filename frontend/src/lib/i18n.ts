...
const en = {
  ...
  uploads: {
    ...
    needsChat: "Send a message first, then attach a file to this chat.",
    ocr: "read by OCR",
    truncated: "shortened",
...
const fr: Dict = {
  ...
  turn: {
    ...
    sourcesUsed: (n: number) => (n === 1 ? "1 source" : `${n} sources`),
    suggestionsLabel: "Poser ensuite",
  ...
  uploads: {
    ...
    needsChat: "Envoyez d'abord un message, puis joignez un fichier à cette conversation.",
    ocr: "lu par OCR",
    truncated: "tronqué",
    pages: (n: number) => (n === 1 ? "1 page" : `${n} pages`),
    ready: (name: string) =>
